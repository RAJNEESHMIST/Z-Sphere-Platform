...
const Logo = ({ className = "", light = false, showTagline = true, circular = false }) => {
    ...
    <div className={`flex items-center gap-2 ${circular ? 'border-2 border-slate-900 rounded-full p-6 bg-white aspect-square shadow-lg' : ''} ${className}`}>
      ...
      <div className="flex flex-col">
        <div className="flex items-center leading-none">
          <span className="text-5xl font-black italic tracking-tighter" style={{ color: textColorPrimary }}>Z</span>
          <span className="text-5xl font-black tracking-tighter -ml-0.5" style={{ color: textColorSecondary }}>K</span>
        </div>
        <div className="flex flex-col mt-1 leading-none">
          <div className="flex text-[11px] font-black tracking-[0.2em] uppercase">
